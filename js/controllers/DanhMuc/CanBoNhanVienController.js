angular.module('WebApiApp').controller('CanBoNhanVienController', function ($rootScope, $scope, $http, $timeout) {
    $scope.Paging = {
        "searchKey": '',
        "pageSize": 15,
        "totalCount": 0,
    ...
    $scope.Del = function (Id) {
        if (confirm('Bạn có chắc chắn muốn xóa đối tượng này ?'))
            $http({
                method: 'GET',
                url: 'api/CanBoNhanVien/Del?Id=' + Id,
    ...
    $rootScope.LoadCanBoNhanVien = function () {
